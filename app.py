...
SYNONYMS = {
    "founder": ["agnishwar", "jayaprakash", "agni", "agnish", "ceo", "creator", "founded", "founded by"],
    "co-founder": ["cofounder", "rithika", "mohan", "cio", "rith", "rithu", "partner", "co founder"],
...
def greet_user(message):
    greetings = ['hello', 'hi', 'hai','hey', 'greetings', 'good morning', 'good afternoon', 'good evening']
    if any(greeting in message.lower() for greeting in greetings):
        return "Hey! I'm Bot Garuda, your virtual assistant. How may I assist you today?"
    return None
